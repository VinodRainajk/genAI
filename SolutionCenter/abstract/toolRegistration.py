...
from SolutionCenter.abstract.systemDefinition.hr.hrSystem import HrSystem
from SolutionCenter.abstract.systemDefinition.hr.tools.employeeSearch import EmployeeSearch
...
hr_System.add_tool(EmployeeSearch())
...
System_List_Info += f"Tool Name: {hr_System.System_Name}, Description: {hr_System.System_Description}\n"

System_Map = {
    card_system.System_Name: card_system,
    invoice_system.System_Name: invoice_system,
    hr_System.System_Name: hr_System
}